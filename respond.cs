...
{//start of namespace
    ...
    {//start of class
        ...
        {//start of method
            ...
            //malicious responses
            add_answers.Add("malicious chatbot malicious bots often trick users by creating a sense of urgency.");
            add_answers.Add("malicious chatbot fake chatbots can ask for sensitive, confedential information.");
            add_answers.Add("malicious chatbot be cautious if a bot pressure asks you for personal data.");
